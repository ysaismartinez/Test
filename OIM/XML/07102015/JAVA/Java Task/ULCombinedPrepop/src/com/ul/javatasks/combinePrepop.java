...
///////////////////////////////////
		   ...
		   return commonName;
            ...
            //Added by Nitin Natekar for PS#New hire AD record reset password next login not selected (This is still an issue with new hire for a ex-UL employee)
            //Date  : 07/08/2015
           public int checkBoxCheck(){      
               return 1;
           }
           //Added by Nitin Natekar for PS#AD Display Name for More Than One Name Reflecting Lower Case
           //Date  : 07/07/2015
           
           public String generateCamelCaseString(String inputString){
               
               String methodName="generateCamelCaseString";
               String[] stringArray = inputString.split(" ");
               String camelCaseString = null;
               for (String s: stringArray)
                       {
                           if(s.length() <= 0) {
                            s = s.substring(0, 0).toUpperCase();
                             }else{
                              s = s.substring(0, 1).toUpperCase() + s.substring(1).toLowerCase();
                             }
                          camelCaseString = camelCaseString + " " + s;
                       }
               return camelCaseString;
           }

            //Updated by Nitin Natekar for PS#AD Display Name for More Than One Name Reflecting Lower Case
            //Date  : 07/07/2015       
	   ...
	   public String generatedisplayName(String preferredName, String firstName, String middleName, String lastName)
		 {
			    ...
			    LOGGER.info(classname + methodName+ "----->>>>        " + "Display Name : " +displayName);
                            ...
                            preferredName = generateCamelCaseString(preferredName);
                            firstName = generateCamelCaseString(firstName);
		            lastName = generateCamelCaseString(lastName);
		            middleName = generateCamelCaseString(middleName);
